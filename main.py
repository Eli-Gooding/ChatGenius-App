...
PINECONE_INDEX_CHAT = os.getenv("PINECONE_INDEX_CHAT")

prompt = "What's going on in the complaint's channel Can you summarize the conversion?"
...
document_vectorstore = PineconeVectorStore(index_name=PINECONE_INDEX_CHAT, embedding=embeddings)
